A python image trainer program, for use with datasets & models. You'll need to install Ursina first before using, simply running pip install ursina in a terminal.
HOW TO USE
